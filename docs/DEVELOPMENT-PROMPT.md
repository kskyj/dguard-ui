...
## Phase 3: 횡단 기능 구현 가이드

> Claude에게 `"docs/DEVELOPMENT-PROMPT.md의 Phase 3을 참고해서 횡단기능 구현해줘"`라고 지시하면,
...
|----------|---------|------|----------|
| B0XNF01-1045 | 최상위 | 이행점검 3가지 방식 | Phase 3 횡단기능 |
| B0XNF01-1055 | 최상위 | 재검색시 상태 유지/갱신 | Phase 3 횡단기능 |
| B0XNF01-1043 | 최상위 | 최소 검출단위 = 검출룰 기준 | Phase 1 스키마 설계 |
| B0XNF01-1044 | 최상위 | 엑셀 출력 + 고유 URL 링크 | Phase 3 횡단기능 |
| B0XNF01-1063 | 최상위 | CSV(tab) 일괄 등록 | Phase 3 횡단기능 |
